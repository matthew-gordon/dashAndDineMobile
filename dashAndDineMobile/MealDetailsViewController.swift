...
class MealDetailsViewController: UIViewController {
    ...
    @IBAction func addToTray(_ sender: Any) {
        ...
        image.image = UIImage(named: "tray-1")
                ...
                if trayRestaurant.id == currentRestaurant.id {
                    ...
                    if let index = inTray {
                        ...
                        let alertView = UIAlertController(
                            title: "Add More?",
                            message: "Your tray already has this item in it. Do you want to add more?",
                    ...
                    let alertView = UIAlertController(
                        ...
                        message: "You're trying to order a meal from another restaurant. Would you like to clear the current tray?",
                        preferredStyle: .alert)
